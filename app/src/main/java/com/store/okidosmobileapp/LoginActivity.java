...
public class LoginActivity extends AppCompatActivity {
    EditText name,email,InputPhoneNumber,InputPassword;
    Button LoginButton;
    TextView joinBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputPhoneNumber = (EditText) findViewById(R.id.login_phone_input_login);
        InputPassword = (EditText) findViewById(R.id.login_password_input_login);
    ...
    private void LoginUser()
    {
        ...
        if(InputPhoneNumber.getText().equals(null))
        {
